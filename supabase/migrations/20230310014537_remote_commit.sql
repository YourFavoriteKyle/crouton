...
--
-- Name: puns; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE "public"."puns" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "pun" "text" NOT NULL,
    "guild_id" numeric
...
ALTER TABLE "public"."puns" OWNER TO "postgres";

--
-- Name: puns_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE "public"."puns" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."puns_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: puns puns_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."puns"
    ADD CONSTRAINT "puns_pkey" PRIMARY KEY ("id");


--
-- Name: puns puns_guild_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."puns"
    ADD CONSTRAINT "puns_guild_id_fkey" FOREIGN KEY ("guild_id") REFERENCES "public"."guilds"("guild_id");
...
--
-- Name: puns; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE "public"."puns" ENABLE ROW LEVEL SECURITY;
...
--
-- Name: TABLE "puns"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE "public"."puns" TO "anon";
GRANT ALL ON TABLE "public"."puns" TO "authenticated";
GRANT ALL ON TABLE "public"."puns" TO "service_role";


--
-- Name: SEQUENCE "puns_id_seq"; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON SEQUENCE "public"."puns_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."puns_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."puns_id_seq" TO "service_role";
